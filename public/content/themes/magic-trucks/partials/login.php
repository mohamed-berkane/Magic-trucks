        ...
        <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3 class="thin text-center">Pas encore inscrit ?</h3>
                    <p class="text-center text-muted">Si vous n'avez pas encore de compte chez nous, <a href="content/themes/magic-trucks/partials/signin.php">Cliquez-ici </a> pour vous enregistrer !</p>
                    <hr>
