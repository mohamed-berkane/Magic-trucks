...
<section class="oupss">
	...
	<div class="welcome__cta">
		<a class="btn btn-info" href=".">Revenir à l'accueil</a>
	</div>
	<!--     <div class="img-404"><img src="<?= get_theme_root_uri() . '/magic-trucks/assets/images/magictrucks10.png'; ?>">
    </div> -->


</section>

<!-- Source : https://codepen.io/donnervetter/pen/VjzLgE -->
			...
			<div class="car_outter">
				<div class="car">
					...
					<div class="decos">
						...
						<div class="ice-cream">
							<div class="mtrucks">Magic-trucks</div>
						</div>
					</div>
					<div>
						<div class="wheel"></div>
