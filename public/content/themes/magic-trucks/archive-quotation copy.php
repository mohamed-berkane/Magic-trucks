                ...
                <div class="panel-body">
                    ...
                    <!-- Je redirige le traitement POST vers admin-post.php  avec la fonction admin_url -->
                        ...
                        <div class="row top-margin">
                            <div class="col-sm-6">
                                <label for="otherdetail">Autre indications</label>
                                <textarea name="otherdetail" id="otherdetail" rows="3" cols="40" placeholder="Si vous avez d'autres précisions à nous donner, décrivez les ici"></textarea>
                                </textarea>
                            </div>
                        </div>
                        <div class="row">
